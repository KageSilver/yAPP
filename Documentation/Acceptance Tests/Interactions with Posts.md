...
5. Editing a post can be done from any full screen post that you have created by selecting any preview of a post
    ...
    - Your diary entries can be found by selecting the "Calendar" button on the right navigation bar and selecting a date to find a post
...
10. To discard the update, select the "Discard" button on the bottom of the panel
...
4. Select the "Sign in" button at the bottom of the panel
5. Select a post you would like to reply to on the home page
6. Select the arrow button on the bottom right of the screen
7. Enter a comment in the textfield labelled "a new comment"
8. Select the "Send" button on the bottom right of the comment panel
9. Your new comment should appear below the public post
10. Done!
...
5. Editing a post can be done from any full screen post that you have created by selecting any preview of a post
    - If a post you created appears on your home page, you can select that post to see the full post
    - Your public posts can be found by selecting the "Profile" button on the bottom navigation bar and selecting the "My Posts" tab on your profile
    - Your diary entries can be found by selecting the "Calendar" button on the bottom navigation bar and selecting a date to find a post
6. Select the three vertical dots on the top right of the screen
7. Select "Edit" on the dropdown menu
8. Edit the post title and content however you wish in the associated textfields
9. To update the post, select the "Update" button on the bottom of the screen
    - A pop-up should appear the confirms the post was updated successfully
10. To discard the update, select the "Discard" button on the bottom of the screen
    - A pop-up should appear if you would like to discard the update, select "Yes"
11. If you updated the post, the post will be updated on your screen
12. Done!
...
5. Editing a comment can be done from any full screen post that you have commented on by selecting the preview of the post you commented on
    - These posts will appear on the home page that you can select, unless you commented on your own post
6. Select the arrow button on the bottom right of the screen to view comments
7. Locate your comment on the full screen of a post and click on it
8. Select "Edit" on the pop-up menu
9. Edit the comment content however you wish in the associated textfield
10. To update the comment, select the "Update Comment" button on the bottom of the panel to edit the comment
11. To discard the update, select the "Cancel" button on the bottom of the panel to edit the comment
12. If you updated the comment, the comment will be updated on your screen
13. Done!
...
5. Deleting a post can be done from any full screen post that you have created by selecting any preview of a post
    ...
    - Your public posts can be found by selecting the "Profile" button on the bottom navigation bar and selecting the "My Posts" tab on your profile
    - Your diary entries can be found by selecting the "Calendar" button on the bottom navigation bar and selecting a date to find a post
6. Select the three vertical dots on the top right on the screen
7. Select "Delete" on the dropdown menu
    - A pop-up should appear if you would like to delete the post, select "Confirm"
8. You should be routed to the psge you selected the deleted post from the post you deleted should not appear
9. Done!
...
6. Select the arrow button on the bottom right of the screen to view comments
7. Locate your comment on the full screen of a post and click on it
8. Select "Delete" on the pop-up menu
    - A pop-up should appear if you would like to delete the comment, select "Confirm"
