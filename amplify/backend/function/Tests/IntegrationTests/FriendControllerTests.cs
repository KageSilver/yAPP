...
public class FriendControllerIntegrationTests : IClassFixture<WebApplicationFactory<Startup>>
{
    ...
    private const string TestUserEmail1 = "bounce1@simulator.amazonses.com";
    ...
    public FriendControllerIntegrationTests(WebApplicationFactory<Startup> factory)
    {
    ...
    public async Task GetFriendsByStatus_ValidRequest_ReturnsFriendsList()
    {
        ...
        Assert.All(friends, friend => Assert.Equal("user1", friend.FromUserName));
    }
