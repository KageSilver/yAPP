...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     */
    usersUpdateUserCreate: (data: User, params: RequestParams = {}) =>
     ...
     *
     * @tags User
     * @name UsersGetUserByNameList
     * @request GET:/api/users/getUserByName
     */
    usersGetUserByNameList: (
      query?: {
        username?: string;
      },
      params: RequestParams = {},
